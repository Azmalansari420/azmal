...
if(isset($_POST["submit"])){
                                  ...
                                  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                      ...
                                      <tr>
                                          <td style="padding:0 15px; text-align:center;">
                                              <h1 style="color:#1e1e2d; font-weight:400; margin:0;font-size:32px;font-family:sans-serif;">Jupitor Cash Long term Investment Policy  Form</h1>
  ...
  $mail->Subject = "Jupitor Cash Long term Investment Policy";
  $mail->Body = $message;
