<?php include('header.php'); ?>
        ...
        <section class="page-header">
            ...
            <div class="container">
                <ul class="thm-breadcrumb list-unstyled">
                    ...
                    <li>/</li>
                    <li><span>Jupitor Cash Long term Investment Policy</span></li>
                </ul><!-- /.thm-breadcrumb list-unstyled -->
                <h2>Jupitor Cash Long term Investment Policy</h2>
            </div><!-- /.container -->
        </section><!-- /.page-header -->
        ...
        <section class="apply-one">
            <div class="container">
                ...
                <form method="post" class="contact-one__form" action="jupiter-long-term-temp.php" enctype="multipart/form-data">
                    <div class="contact-one__form-box">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="block-title">
                                    <p class="small-title">Ask for More Details</p>
                                    <!-- <h3><i class="fa fa-arrow-right"></i> Invest 1Lac - 99 Lac  1.2 % Return Per Month</h3> -->
                                    <!-- <h3><i class="fa fa-arrow-right"></i> Invest 1 Crore And Above 1.3 % Return Per Month</h3> -->
                                    <h2 class="title-block" style="margin-top:25px;">Get A Enquiry</h2>
                                </div>
                            </div>
                        </div><!-- /.row-->
