<?php include('header.php'); ?>
        ...
        <section class="page-header">
            ...
            <div class="container">
                <ul class="thm-breadcrumb list-unstyled">
                    ...
                    <li>/</li>
                    <li><span>Jupitor Cash Money-Back Policy</span></li>
                </ul><!-- /.thm-breadcrumb list-unstyled -->
                <h2>Jupitor Cash Money-Back Policy</h2>
            </div><!-- /.container -->
        </section><!-- /.page-header -->
        ...
        <section class="apply-one">
            <div class="container">
                ...
                <form method="post" class="contact-one__form" action="investment-policy-temp.php" enctype="multipart/form-data">
