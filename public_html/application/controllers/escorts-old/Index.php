...
class Index extends Front_Controller {
	...
	public function index($slug=false){
		...
		//echo $slug;
		if($slug=='index'){
			$page = $this->Page_model->fetch_row_by_field('slug', 'p_escorts');
		}else{
		...
		if(isset($page->id)){
			if($slug=='index'){
				$this->data['breadcrumbs'] = array('escorts/'=> 'Male Escorts');
				
				$this->data['title'] 		= $page->title;
				$this->data['state'] 		= '';
			}else{
				$this->data['breadcrumbs'] = array('escorts/'=> 'Male Escorts', 'escorts/'.$city_slug=> $city);
				if($locality_slug!=''){
					$this->data['breadcrumbs'] = array('escorts/'=> 'Male Escorts', 'escorts/'.$city_slug=> $city, 'escorts/'.$locality_slug=> $locality);
				}
