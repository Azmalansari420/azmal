...
class Index extends Front_Controller {
	...
	public function index($slug=false){
		...
		$city_slug					= '';
		$locality_slug				= '';
		$type_slug					= 'male-escorts';
		//$this->data['this'] 		= $this;
		//echo $slug;
		if($slug=='index'){
			$page = $this->Page_model->fetch_row_by_field('slug', 'male_escorts');
		}else{
		...
		if(isset($page->id)){
			if($slug=='index'){
				$this->data['breadcrumbs'] = array('male-escorts/'=> 'Male Escorts');
				
				$this->data['title'] 		= $page->title;
				$this->data['state'] 		= '';
			}else{
				$this->data['breadcrumbs'] = array('male-escorts/'=> 'Male Escorts', 'male-escorts/'.$city_slug=> $city);
				if($locality_slug!=''){
					$this->data['breadcrumbs'] = array('male-escorts/'=> 'Male Escorts', 'male-escorts/'.$city_slug=> $city, 'male-escorts/'.$locality_slug=> $locality);
				}
			...
			if(isset($page->content_male)){
				$this->data['meta_title'] 		= $page->meta_title_male;
				$this->data['meta_description'] = $page->meta_description_male;
				$this->data['meta_keywords'] 	= $page->meta_keywords_male;
			}
