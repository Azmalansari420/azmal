	...
	public function add($id=false){
		...
		{//form
			...
			$elements = array(
					...
					$template_select,
					array('name' => 'includes', "label"=>"Includes - Data Source", "id"=>"includes", "type"=>"textarea", "validation"=>'', 'comment'=>'[type="model", name="page_model", method="method_name", var="variable"]<br />[type="helper", name="utility_helper", method="method_name",  var="variable"]<br />[type="js", name="scripts.js", before="common.js", after="jquery.js"]<br />[type="css", name="styles.js", before="file.css", after="bootstrap.css"]'),
